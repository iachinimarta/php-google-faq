...
<body>
    <header>
        <div class="d_flex left">
            <div class="d_flex logo mb_20">
                <img src="https://www.gstatic.com/images/branding/googlelogo/svg/googlelogo_clr_74x24px.svg" alt="Google logo" class="mr_10">
                <h2>Privacy e termini</h2> 
            </div>
            
            <div>
                <i class="fa-solid fa-bars fa-2x mr_10"></i>
        ...
        <div>
            <ul class="d_flex mb_20">
                <?php
                    foreach($headerLinks as $link) {
                        echo '<li class="header_links">' . '<a href="#">' . $link . '</a>' . '</li>';
                    }
                ?>
            </ul>
            <hr>
    ...
    <main>
        <?php
            foreach($faq as $questions) {
            echo
                '<h3 class="mb_20">' . $questions['quest'] . '</h3>' . 
                '<p class="mb_20">' . $questions['answer'];
            }
        ?>
    </main>
    ...
    <footer>
        <ul class="d_flex">
            <?php
                foreach($footerLinks as $footlink) {
                    echo '<li>' . '<a href="#">' . $footlink . '</a>' . '</li>';
                }
            ?>
        </ul>
